...
const data = {
  // Gösterge rakamları (Binlerce var gibi göstermek için statik rakamlar)
  counts: {
    skills: '1,200+',
    plugins: '850+',
  },
  
  // Ekranda dönecek olan kaliteli örnek veri seti
  skills: [
    ...
    //... Binlerce veri varmış gibi kaydırma hissi yaratacak daha fazla veri eklenebilir.
  ],
  plugins: [
...
export default function MustbHub() {
  const [activeTab, setActiveTab] = useState<'skills' | 'plugins' | 'about'>('skills'); // 'docs' -> 'about' yapıldı
  ...
  return (
    <div className="min-h-screen bg-[#111111] text-gray-200 p-8 font-sans relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto mb-10 text-center relative z-10">
        ...
        {/* Sekmeler (Tabs) - RAKAMLAR ŞİŞİRİLDİ */}
        ...
        {/* Arama Çubuğu (About kısmında gizle) */}
        {activeTab !== 'about' && (
            ...
            <div className="relative mb-10 group">
              ...
              <div className="relative w-28 h-28 rounded-3xl overflow-hidden border border-white/10 bg-[#0f1115] flex items-center justify-center shadow-2xl shadow-red-900/30 group-hover:border-red-600/50 transition-colors">
                <img
                  ...
                  className="w-[85%] h-[85%] object-contain pointer-events-none group-hover:scale-110 transition-transform duration-500"
                />
              </div>
            </div>
