      ...
      animate={isVisible
        ? {
            ...
            transition: {
              ...
              x: { duration: 0.65, delay: index * 0.11, ease: [0.22, 1, 0.36, 1],
                   repeat: Infinity, repeatType: "mirror" as const,
                   repeatDelay: 0, duration: seed.dur },
              y: { duration: 0.65, delay: index * 0.11, ease: [0.22, 1, 0.36, 1],
                   repeat: Infinity, repeatType: "mirror" as const,
                   repeatDelay: 0, duration: seed.dur * 1.1 },
              rotate: { duration: 0.65, delay: index * 0.11, ease: [0.22, 1, 0.36, 1],
                        repeat: Infinity, repeatType: "mirror" as const,
