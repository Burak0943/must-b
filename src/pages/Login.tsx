...
import { Mail, Lock, Eye, EyeOff, ArrowRight, Loader2, Github, Facebook, Twitter } from 'lucide-react';
                  ...
                  <motion.form key="auth-form" onSubmit={handleAuth} initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} className="space-y-4">
                    ...
                    <div className="flex justify-between gap-2">
                      {[
                        ...
                        { id: 'github', icon: <Github className="w-4 h-4 text-white" /> },
                        { id: 'apple', icon: <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.04C10.5 2.04 9.06 3 8.34 4.38c-.78 1.5-.66 3.12.3 4.44C9.54 10.02 11.04 11 12.6 11c1.5 0 2.88-.9 3.66-2.28.78-1.5.66-3.12-.3-4.44C15.06 2.94 13.56 2.04 12 2.04zm-3.66 9.6c-2.4 0-4.56 1.68-5.34 3.96-.84 2.52-.3 5.4 1.38 7.56 1.14 1.44 2.7 2.4 4.38 2.4 1.8 0 3.36-1.14 4.86-1.14 1.5 0 3.06 1.14 4.86 1.14 1.68 0 3.24-.96 4.38-2.4 1.68-2.16 2.22-5.04 1.38-7.56-.78-2.28-2.94-3.96-5.34-3.96-1.62 0-3.18.96-4.26.96-1.08 0-2.64-.96-4.26-.96z"/></svg> },
